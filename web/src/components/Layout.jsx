...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 flex flex-col bg-white border-r border-gray-100 shadow-sm transition-all duration-300
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block pl-3 border-l border-gray-200">
              ...
              <p className="text-xs text-emerald-600 font-medium">
                {user.plan === 'free' ? '30-Day Free Trial' : `${user.plan} Plan`}
              </p>
            </div>
          </div>
        </header>
